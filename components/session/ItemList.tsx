            ...
            >
              ...
              <div className="flex">
                ...
                <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-1.5 flex-shrink-0">
                      ...
                      {showKebab && (
                        <button
                          ...
                          className="w-8 h-8 flex items-center justify-center rounded-lg text-slate-400 hover:text-slate-600 hover:bg-slate-100 active:scale-[0.95] transition-all"
                        >
                          •••
                        </button>
                      )}
                  ...
                  {/* Unclaimed pulsing hint */}
                  {remaining > 0 && !claimedByMe && (
                    <div className="px-4 pb-3">
                      <span className="inline-flex items-center gap-1.5 rounded-lg bg-teal-50 border border-teal-200/80 text-teal-700 px-3 py-1.5 text-sm font-medium">
                      ...
                      <div className="flex items-center gap-2 flex-wrap">
                        {claimers.map(({ participant }) => (
                          ...
                          >
                            ...
                            <span className="opacity-90">{participant.name.split(' ')[0]}</span>
                          </div>
                        ))}
                      </div>
                          ...
                          return (
                            ...
                            >
                              <div className="flex items-center gap-2 min-w-0">
                                <div
                                  className="flex-shrink-0 w-5 h-5 rounded-full text-white text-[10px] font-semibold flex items-center justify-center"
                                  style={{ backgroundColor: getParticipantColor(participant.name) }}
                                >
